    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('latitude', models.FloatField(blank=True, validators=[fridge.validators.latitude_longitude_validators])),
                ('longitude', models.FloatField(blank=True, validators=[fridge.validators.latitude_longitude_validators])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_open', models.PositiveSmallIntegerField(choices=[(0, 'Opened'), (1, 'Closed')], default=0)),
